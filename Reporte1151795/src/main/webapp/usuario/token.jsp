			...
			<div class="card-body">
				...
				<fieldset class="form-group">
					<label>Host</label> <input type="text"
						...
						name="host" required="required" placeholder="Dirección del servidor de base de datos">
				</fieldset>
				
				<fieldset class="form-group">
					<label>Userdb</label> <input type="email"
						value="<c:out value='${connectiontoken.userdb}' />" class="form-control"
						name="userdb" required="required" placeholder="Nombre del usuario de conexión a la base de datos">
				</fieldset>
